...
def generate_images(generative_model, fmri_latents_dataset_train, fmri_latents_dataset_test, config):
    ...
    grid_imgs.save('/home/yuchen/mind-vis/results/generation/test/samples_train.png')
    ...
    grid_imgs.save('/home/yuchen/mind-vis/results/generation/test/samples_test.png')
    ...
    metric_file_path = '/home/yuchen/mind-vis/results/generation/test/metric.txt'
